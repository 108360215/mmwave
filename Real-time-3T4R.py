...
set_radar = SerialConfig(name='ConnectRadar', CLIPort='COM3', BaudRate=115200)  # connect to your comport

config = 'C:/Users/逄子毅/Desktop/RealTimeSys_cleanup/radar_config/xwr68xx_profile_2021_03_23T08_12_36_405.cfg'

class Realtime_sys():
    def RTSPVideoWriterObject(self):
